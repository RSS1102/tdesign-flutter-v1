...
| onChanged | ValueChanged<List<String>>? | - | 状态变化监听器 |
| onOverloadChecked | VoidCallback? | - | 超过最大可勾选的个数 |
| spacing | double? | - | CheckBoxicon和文字的距离 |
| style | TCheckboxVariant? | - | CheckBox复选框样式：圆形或方形 |
