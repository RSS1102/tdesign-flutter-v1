...
class TInputResolve {
  ...
  static TextStyle resolveHintTextStyle({
    ...
    if (theme?.hintTextStyle != null) {
      return theme!.hintTextStyle!;
    }
    final tTheme = context.tTheme;
    return TextStyle(
  ...
  static Color resolveClearBtnColor({
    ...
    if (theme?.clearBtnColor != null) {
      return theme!.clearBtnColor!;
    }
  ...
  static Color resolveAdditionInfoColor({
    ...
    if (theme?.additionInfoColor != null) {
      return theme!.additionInfoColor!;
    }
    return context.tTheme.textColorPlaceholder;
  }
  ...
  static EdgeInsetsGeometry resolveContentPadding({
    ...
    if (instancePadding != null) {
      return instancePadding;
    }
  ...
  static BoxDecoration? resolveCardStyleDecoration({
    ...
    if (instanceDecoration is BoxDecoration) {
      return instanceDecoration;
    }
    if (layout != TInputLayout.cardStyle) {
      return null;
    }
    final tTheme = context.tTheme;
    final effectiveCardStyle = cardStyle ?? theme?.cardStyle;
    if (effectiveCardStyle == null) {
      return null;
    }
  ...
  static TInputSpacer resolveSpacer({
    ...
    if (instanceSpacer != null) {
      return instanceSpacer;
    }
